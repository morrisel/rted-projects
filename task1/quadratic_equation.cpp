...
/*
   int main()
   {
   Equation eq(10,20.7,12.3);
   std::cout << eq << std::endl;


// Usage example
Equation eq1(1, 2, 3);
Equation eq2(40, 50, 60);

std::cout << "Equation 1: " << eq1 << std::endl;
std::cout << "Equation 2: " << eq2 << std::endl;

Equation result_addition = eq1 + eq2;
std::cout << "Addition result: " << result_addition << std::endl;

Equation result_addition_double = eq1 + 40.0;
std::cout << "Addition result with double: " << result_addition_double << std::endl;

Equation result_double_addition = 40.0 + eq1;
std::cout << "Double addition result: " << result_double_addition << std::endl;
